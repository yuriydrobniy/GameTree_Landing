...
(function(global) {
    ...
    extend(Mimi.Signups.EmbedValidation.prototype, {
        initialize: function() {
            this.form         = document.getElementById('ema_bottom_signup_form');
            this.submit       = document.getElementById('webform_bottom_submit_button');
            this.callbackName = 'jsonp_callback_' + Math.round(100000 * Math.random());
            this.validEmail   = /.+@.+\..+/
        },
        ...
        emailValidation: function() {
            var email = document.getElementById('signup_bottom_email');
